...
const DICT = {
  nl: {
    ...
    'shell.brand_subtitle': 'Staff workspace',
    'shell.brand_meta': 'KOG systeem',
    'shell.open_sidebar': 'Zijbalk openen',
    'shell.close_sidebar': 'Zijbalk sluiten',
    'shell.sidebar_collapse': 'Zijbalk inklappen',
    'shell.sidebar_expand': 'Zijbalk uitklappen',
    'shell.notifications': 'Meldingen',
    'shell.notifications_empty': 'Geen nieuwe meldingen',
    'shell.settings': 'Instellingen',
    'shell.account': 'Account',
    'shell.role_staff': 'Medewerker',
    'shell.role_client': 'Klant',
    'shell.portal_subtitle': 'Klantportaal',
    'shell.breadcrumb_detail': 'Detail',
    'shell.breadcrumb_component': 'Bouwdeel',
    'shell.breadcrumb_rapport': 'Bestuursrapport',
    'nav.portal_home': 'Mijn panden',
    ...
    'access.err_forbidden': 'Uw sessie heeft geen medewerker-rechten. Log opnieuw in via Mijn Pand.',
    'access.err_auth_failed': 'Uw sessie kon niet worden geverifieerd ({msg}). Log opnieuw in via Mijn Pand.',
    ...
    'cal.full_button': 'Volledige kalender',
    'cal.next': 'Volgende',
    'cal.none': 'Geen gepland onderhoud',
    'cal.title': 'Onderhoudskalender',
    'cal.jump_next': 'Naar volgend onderhoud',
    'cal.no_month': 'Geen onderhoud deze maand',
  ...
  en: {
    ...
    'shell.brand_subtitle': 'Staff workspace',
    'shell.brand_meta': 'KOG system',
    'shell.open_sidebar': 'Open sidebar',
    'shell.close_sidebar': 'Close sidebar',
    'shell.sidebar_collapse': 'Collapse sidebar',
    'shell.sidebar_expand': 'Expand sidebar',
    'shell.notifications': 'Notifications',
    'shell.notifications_empty': 'No new notifications',
    'shell.settings': 'Settings',
    'shell.account': 'Account',
    'shell.role_staff': 'Staff member',
    'shell.role_client': 'Client',
    'shell.portal_subtitle': 'Client portal',
    'shell.breadcrumb_detail': 'Detail',
    'shell.breadcrumb_component': 'Component',
    'shell.breadcrumb_rapport': 'Board report',
    'nav.portal_home': 'My properties',
    ...
    'access.err_forbidden': 'Your session does not have staff permissions. Sign in again via Mijn Pand.',
    'access.err_auth_failed': 'Your session could not be verified ({msg}). Sign in again via Mijn Pand.',
    ...
    'cal.full_button': 'Full calendar',
    'cal.next': 'Next',
    'cal.none': 'No maintenance scheduled',
    'cal.title': 'Maintenance calendar',
    'cal.jump_next': 'Jump to next maintenance',
    'cal.no_month': 'No maintenance this month',
